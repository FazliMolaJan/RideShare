...
public class MyBookingsAdapter extends RecyclerView.Adapter<MyBookingsAdapter.ViewHolder> {
    List<MyBookingsModelClass> recentSearchesModelClasses = new ArrayList<>();
    Context context;
    Fragment fragment;
    String dropPoint;
    ...
    public MyBookingsAdapter(Context context, List<MyBookingsModelClass> recentSearchesModelClasses) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
                                         int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_bookings_design, parent, false);
